...
const PhoneBackground = () => {
  return <svg className="bg_phone" width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 414 736" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <filter id="filter0_f" x="-156" y="217" width="764.417" height="764.417" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"/>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
        <feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur"/>
      </filter>
      <filter id="filter1_f" x="-55" y="-217" width="727.503" height="727.503" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix"/>
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
        <feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur"/>
      </filter>
